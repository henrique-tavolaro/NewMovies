...
@Inject constructor(
    ...
    override suspend fun getMovie(query: String) {
        retrofitService.getMovies(search = query)
    }

    override suspend fun getMovieDetails(imdbID: String) {
        retrofitService.getMovieDetails(imdbID = imdbID)
    }
}